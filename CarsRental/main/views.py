...
def index_website(Http_RQ:HttpRequest):
    msg="<center><h1 style= color:blue>Hello World, This is my new HOME for Car Rentals Website  ! we're excited to welcome you here.</h1></center>"
    return HttpResponse(msg)
def about(Http_RQ:HttpRequest):
    msg="<center><h1 style= color:blue>A simple paragraph about Car Rentals. </h1></center>"
    return HttpResponse(msg)
